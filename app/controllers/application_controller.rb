class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:accept_invitation, keys: [:name, :email, :last_name, :first_name, :last_name_kana, :first_name_kana, :postcode, :address, :phone_number, :room_id, :family_id, :invited_by_id, :invitation_token])
  end
